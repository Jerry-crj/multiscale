...
uniaxialMaterial Concrete01    101     [expr -34473.8*1.5]    [expr -0.005*1.5]     [expr -24131.66*1.3]     -0.03
uniaxialMaterial Concrete01    102        [expr -$fc*1.5]      [expr -0.002*1.5]        0.0        -0.01
uniaxialMaterial Steel01       103       [expr 248200.*1.5]     2.1e8        0.015

# uniaxialMaterial Elastic  10      $GJ
set d 0.4572
source RCsection.tcl
RCsection   1  $d  $d     0.04        1      2        3       3     0.00051       8       8       10       10      $GJ
RCsection  101  $d  $d     0.04        1      2        3       3     0.00051       8       8       10       10      $GJ
# section Aggregator            2        10      T    -section    1
# section Aggregator           102       10      T    -section   101
set colSec 1  
set colSec1 101  
...
element dispBeamColumn    8        8    118       $np      $colSec1    1
element dispBeamColumn    118    118    128       $np      $colSec1    1
element dispBeamColumn    128    128    138       $np      $colSec1    1
element dispBeamColumn    138    138    148       $np      $colSec1    1
element dispBeamColumn    148    148    158       $np      $colSec1    1
element dispBeamColumn    158    158    168       $np      $colSec1    1
element dispBeamColumn    168    168    178       $np      $colSec1    1
element dispBeamColumn    178    178    188       $np      $colSec1    1
element dispBeamColumn    188    188    198       $np      $colSec1    1
element dispBeamColumn    198    198     13       $np      $colSec1    1
...
recorder Node -file node19.out -time -node 19 -dof 1 2 disp
